...
class PersonPoolBasedSecurityAspectsTest {
  ...
  void setup(
    ...
    PersonPoolBasedSecurityAspects securityAspects =
        new PersonPoolBasedSecurityAspects(this.permissionEvaluator);
  ...
  void testShouldPreventSecuredMethodCallWithPatientReturnValue() {
    ...
    var exception =
        assertThrows(Exception.class, () -> this.dummyClass.methodWithPatientReturnValue(1));
    assertThat(exception).isExactlyInstanceOf(IllegalSecuredObjectAccessException.class);
  }
